...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn("border-b border-ink-100 transition-colors hover:bg-ink-50/60", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left text-xs font-semibold uppercase tracking-wide text-ink-500",
      className
    )}
    {...props}
  />
